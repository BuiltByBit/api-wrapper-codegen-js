...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BuiltByBitApi.PostV2ResourcesEmbedDownloadRequest();
  });
  ...
  describe('PostV2ResourcesEmbedDownloadRequest', function() {
    it('should create an instance of PostV2ResourcesEmbedDownloadRequest', function() {
      // uncomment below and update the code to test PostV2ResourcesEmbedDownloadRequest
      //var instance = new BuiltByBitApi.PostV2ResourcesEmbedDownloadRequest();
      //expect(instance).to.be.a(BuiltByBitApi.PostV2ResourcesEmbedDownloadRequest);
    });
