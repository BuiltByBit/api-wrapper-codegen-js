...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BuiltByBitApi.Analytic();
  });
  ...
  describe('Analytic', function() {
    it('should create an instance of Analytic', function() {
      ...
      //var instance = new BuiltByBitApi.Analytic();
      //expect(instance).to.be.a(BuiltByBitApi.Analytic);
    });
    ...
    it('should have the property single (base name: "single")', function() {
      // uncomment below and update the code to test the property single
      //var instance = new BuiltByBitApi.Analytic();
      //expect(instance).to.be();
    });
