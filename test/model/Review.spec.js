...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BuiltByBitApi.Review();
  });
  ...
  describe('Review', function() {
    it('should create an instance of Review', function() {
      ...
      //var instance = new BuiltByBitApi.Review();
      //expect(instance).to.be.a(BuiltByBitApi.Review);
    });
    ...
    it('should have the property writtenById (base name: "written_by_id")', function() {
      // uncomment below and update the code to test the property writtenById
      //var instance = new BuiltByBitApi.Review();
      //expect(instance).to.be();
    });
