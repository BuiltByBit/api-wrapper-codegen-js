...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BuiltByBitApi.Description();
  });
  ...
  describe('Description', function() {
    it('should create an instance of Description', function() {
      ...
      //var instance = new BuiltByBitApi.Description();
      //expect(instance).to.be.a(BuiltByBitApi.Description);
    });
    ...
    it('should have the property bbcode (base name: "bbcode")', function() {
      // uncomment below and update the code to test the property bbcode
      //var instance = new BuiltByBitApi.Description();
      //expect(instance).to.be();
    });
