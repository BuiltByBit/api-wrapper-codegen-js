...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BuiltByBitApi.DownloadStatus();
  });
  ...
  describe('DownloadStatus', function() {
    it('should create an instance of DownloadStatus', function() {
      // uncomment below and update the code to test DownloadStatus
      //var instance = new BuiltByBitApi.DownloadStatus();
      //expect(instance).to.be.a(BuiltByBitApi.DownloadStatus);
    });
