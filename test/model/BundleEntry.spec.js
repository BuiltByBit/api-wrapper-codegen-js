...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BuiltByBitApi.BundleEntry();
  });
  ...
  describe('BundleEntry', function() {
    it('should create an instance of BundleEntry', function() {
      // uncomment below and update the code to test BundleEntry
      //var instance = new BuiltByBitApi.BundleEntry();
      //expect(instance).to.be.a(BuiltByBitApi.BundleEntry);
    });
