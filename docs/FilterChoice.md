...
------------ | ------------- | ------------- | -------------
**key** | **String** |  | 
**count** | **Number** | The dynamic count of relevant resources based on the already-applied filter options.  This may be *null* if we&#39;re unable to provide a count for a specific filter combination. | [optional] 
