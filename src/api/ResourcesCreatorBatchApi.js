...
/**
* ResourcesCreatorBatch service.
* @module api/ResourcesCreatorBatchApi
* @version v2
*/
export default class ResourcesCreatorBatchApi {

    /**
    * Constructs a new ResourcesCreatorBatchApi. 
    * @alias module:api/ResourcesCreatorBatchApi
    * @class
    ...
    */
     ...
     * @callback module:api/ResourcesCreatorBatchApi~getV2ResourcesCreatorBatchCallback
     ...
     * @param {module:api/ResourcesCreatorBatchApi~getV2ResourcesCreatorBatchCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ResourcesCreatorBatchApi~postV2ResourcesCreatorBatchCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ResourcesCreatorBatchApi~postV2ResourcesCreatorBatchCallback} callback The callback function, accepting three arguments: error, data, response
